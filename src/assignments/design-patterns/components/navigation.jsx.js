...
import {SaveButton, DeleteButton} from './button.jsx'
...
class Footer extends React.Component {
  ...
  render() { 
    ...
    Name: <input type="text" value = {this.state.value} onChange={this.handleChange} name="name" placeholder ="Enter your name"/>
